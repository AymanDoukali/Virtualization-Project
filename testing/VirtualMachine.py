...
class VirtualMachine(ABC):
    def __init__(self, name, soft, user, password):
        self.name = name
        self.soft = soft
        self.user = user
        self.password = password
    def __str__(self):
        return self.name, self.soft
...
class VBVM(VirtualMachine):
    def __init__(self, name, soft, user, password):
        super().__init__(name, soft, user, password)
...
class VMwareVM(VirtualMachine):
    def __init__(self, name, soft, user, password, path):
        super().__init__(name, soft, user, password)
        self.path = path
